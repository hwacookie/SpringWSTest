...
public class RegisterApiController implements RegisterApi {
    ...
    public ResponseEntity<Void> register(@NotNull @ApiParam(value = "the users email address", required = true) @Valid @RequestParam(value = "email", required = true) String email) {
